...
or (sometimes command above may not work, then delete by cloud service):

  Get-AzureDisk | where { $_.AttachedTo.HostedServiceName -eq "datastax-perftest" } | Remove-AzureDisk -DeleteVHD
